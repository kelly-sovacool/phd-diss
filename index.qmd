...
_C. difficile_ [@theriot_antibiotic-induced_2016;@sorg_inhibiting_2010].
...
Machine learning approaches to analyze large datasets have transformed
the quantitative sciences towards a data-driven paradigm.

ml-based science to learn about underlying biology [@kapoor_leakage_2022], and practical application to
improve health care.
