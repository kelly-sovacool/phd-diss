...
Choosing this threshold allowed for comparison to EHR models
which reported precision at that threshold.
However, rather than evaluating performance at a single threshold,
we could extend this analysis to perform a decision threshold analysis.
...
We could then compare the net benefit of different modeling approaches.
