...
data, or entire EHRs.
However, none have focused on using the initial state of the gut microbiome to
predict CDI severity, despite ample evidence for a link between dysbiosis and
_C. difficile_ colonization, infection, and recurrence.
...
use when comparing models for clinical applications.
The importance of each quadrant of the confusion matrix depends on the application
as well as the nature of the dataset.
