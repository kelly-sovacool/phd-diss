...
risk reduction (ARR) from randomized controlled trials (@eq-arr and @eq-nnt) [@cook_number_1995].
...
thresh_dat %>% 
  filter(strategy == 'model', outcome != 'idsa') %>% 
  group_by(decision_threshold, outcome) %>% 
  summarise(
