...
```{r plot_risk_thresholds, fig.width=6.5, fig.height=5.5}
...
plot_risk <- thresh_dat %>% 
  ...
  theme(text = element_text(size = 10, family = 'Helvetica'),
        ...
        plot.margin = margin(10,5,0,7))
plot_grid(plot_decision, plot_risk,
          nrow = 2, labels = 'AUTO', 
          align = 'hv', axis = 'l')
```
\justify
...
`r pragmatic_nns` for the pragmatic definition at the 95th percentile of risk (@fig-risk).
